...
%setup -q -n wayland-1.24.0
cd %{_builddir}/wayland-1.24.0
pushd ..
cp -a wayland-1.24.0 build32
popd
pushd ..
cp -a wayland-1.24.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1751900989
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libwayland-client.so.0.24.0
/V3/usr/lib64/libwayland-cursor.so.0.24.0
/V3/usr/lib64/libwayland-egl.so.1.24.0
/V3/usr/lib64/libwayland-server.so.0.24.0
...
/usr/lib64/libwayland-server.so.0.24.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libwayland-client.so.0
/usr/lib32/libwayland-client.so.0.24.0
/usr/lib32/libwayland-cursor.so.0
/usr/lib32/libwayland-cursor.so.0.24.0
/usr/lib32/libwayland-egl.so.1
/usr/lib32/libwayland-egl.so.1.24.0
/usr/lib32/libwayland-server.so.0
/usr/lib32/libwayland-server.so.0.24.0
